...
namespace FliesProject.Models.Events
{
    ...
    public static class ChatScope
    {
        ...
        public static async Task<ChatResponse> GenerateAnswer(string apiKey, Conversation conversation, bool enableReasoning, bool enableSearching)
        {
            var basicConversationInstruction = $@"Your name is **Flies**, you are an AI developed by **Filies team**. Your **sole purpose** is to assist the user in learning English. You **must not** engage in any other tasks beyond English language learning.  
