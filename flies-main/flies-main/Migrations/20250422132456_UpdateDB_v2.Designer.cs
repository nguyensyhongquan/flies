...
namespace FliesProject.Migrations
{
    ...
    [Migration("20250422132456_UpdateDB_v2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Certificate", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Course", b =>
                {
                    b.Property<int>("CourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.CourseTransaction", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Enrollement", b =>
                {
                    b.Property<int>("EnrollementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Lesson", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizComment", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizQuestion", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizTransaction", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizWritingSample", b =>
                {
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Section", b =>
                {
                    b.Property<int>("SectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "Username" }, "UQ__Users__F3DBC5729881F0EA")
                        .IsUnique();

                    b.ToTable("Users");
                });

            modelBuilder.Entity("FliesProject.Models.Entities.UserCourseProgress", b =>
                {
            ...
            modelBuilder.Entity("CourseQuiz", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .IsRequired()
                        .HasConstraintName("FK__course_qu__cours__72C60C4A");

                    b.HasOne("FliesProject.Models.Entities.Quiz", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Certificate", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.Enrollement", "Enrollement")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Course", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.User", "CreatedByNavigation")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Enrollement", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.Course", "Course")
                        .WithMany("Enrollements")
                        .HasForeignKey("CourseId")
                        .IsRequired()
                        .HasConstraintName("FK__enrolleme__cours__656C112C");

                    b.HasOne("FliesProject.Models.Entities.User", "Mentor")
                        .WithMany("EnrollementMentors")
                        .HasForeignKey("MentorId")
                        .IsRequired()
                        .HasConstraintName("FK__enrolleme__mento__6477ECF3");

                    b.HasOne("FliesProject.Models.Entities.User", "Student")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Lesson", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.Section", "Section")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.Message", b =>
                {
                    ...
                    b.HasOne("FliesProject.Models.Entities.User", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizAnswer", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.QuizQuestion", "Question")
            ...
            modelBuilder.Entity("FliesProject.Models.Entities.QuizComment", b =>
                {
                    b.HasOne("FliesProject.Models.Entities.QuizComment", "ParentComment")
                    ...
                    b.HasOne("FliesProject.Models.Entities.User", "User")
                        .WithMany("QuizComments")
                        .HasForeignKey("UserId")
                        .IsRequired()
